...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""RedMap"",
            ""id"": ""631c444f-8b93-48d9-b780-6790c2b3947b"",
            ""actions"": [
                {
                    ""name"": ""MoveRed"",
                    ""type"": ""Value"",
                    ""id"": ""6c699559-f628-4504-ba71-84cd612fad41"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""RedJump"",
                    ""type"": ""Button"",
                    ""id"": ""fd109f09-90be-4f6f-9589-0ebf30e2d570"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""81d30653-562b-4b3a-8507-ab283d179a63"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""84d5c9cd-3922-4837-97c7-493410fa9342"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""9c74ca5e-f0f9-4da6-b42e-de1225ce4725"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    // RedMap
    private readonly InputActionMap m_RedMap;
    ...
    public struct RedMapActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public RedMapActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "RedMap/MoveRed".
        /// </summary>
        public InputAction @MoveRed => m_Wrapper.m_RedMap_MoveRed;
        /// <summary>
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_RedMap; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="RedMapActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(RedMapActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="RedMapActions" />
        public void AddCallbacks(IRedMapActions instance)
        {
            if (instance == null || m_Wrapper.m_RedMapActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_RedMapActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="RedMapActions" />
        private void UnregisterCallbacks(IRedMapActions instance)
        {
            @MoveRed.started -= instance.OnMoveRed;
            @MoveRed.performed -= instance.OnMoveRed;
            @MoveRed.canceled -= instance.OnMoveRed;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="RedMapActions.UnregisterCallbacks(IRedMapActions)" />.
        /// </summary>
        /// <seealso cref="RedMapActions.UnregisterCallbacks(IRedMapActions)" />
        public void RemoveCallbacks(IRedMapActions instance)
        {
            if (m_Wrapper.m_RedMapActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="RedMapActions.AddCallbacks(IRedMapActions)" />
        /// <seealso cref="RedMapActions.RemoveCallbacks(IRedMapActions)" />
        /// <seealso cref="RedMapActions.UnregisterCallbacks(IRedMapActions)" />
        public void SetCallbacks(IRedMapActions instance)
        {
            foreach (var item in m_Wrapper.m_RedMapActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_RedMapActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "RedMap" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="RedMapActions.AddCallbacks(IRedMapActions)" />
    /// <seealso cref="RedMapActions.RemoveCallbacks(IRedMapActions)" />
    public interface IRedMapActions
    {
        /// <summary>
        ...
        /// <summary>
        /// Method invoked when associated input action "RedJump" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
